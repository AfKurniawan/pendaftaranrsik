...
public class JadwalPoliEksekutifBesok extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poli_eksekutif_besok);
        ...
        mManager = new LinearLayoutManager(JadwalPoliEksekutifBesok.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mManager);
        mRecyclerView.setNestedScrollingEnabled(false);

        mAdapter = new JadwalAdapter(JadwalPoliEksekutifBesok.this, mItems);
    ...
    protected void onResume(){
        ...
        if(action == null || !action.equals("Already created")) {
            ...
            Intent intent = new Intent(this, JadwalPoliEksekutifBesok.class);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(final MenuItem item) {
                ...
                if (id == R.id.nav_history) {
                    Intent intent = new Intent(JadwalPoliEksekutifBesok.this, HistoryListActivity.class);
                    startActivity(intent);

                }else if (id == R.id.menu_hari_ini){
                    Intent intent = new Intent(JadwalPoliEksekutifBesok.this, PilihHariPoliReguler.class);
                    startActivity(intent);
    ...
    private void logoutConfirmDialog() {
        ...
        ((Button) dialog.findViewById(R.id.bt_accept)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JadwalPoliEksekutifBesok.this, LoginActivity.class);
    ...
    public void initJadwalBesok() {
        ...
        if (Harihariini == "Sabtu") {
            ...
            headerJadwal.setText("Jadwal Poli Eksekutif Lusa");
    ...
    public void showDialogJadwalWeekend(){
        ...
        if (Harihariini == "Sabtu") {
            ...
            title.setText("Jadwal Hari " + hariBesok + " Tidak tersedia");
