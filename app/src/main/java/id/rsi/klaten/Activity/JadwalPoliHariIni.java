...
public class JadwalPoliHariIni extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_poli_hari_ini);
        ...
        mManager = new LinearLayoutManager(JadwalPoliHariIni.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mManager);
        mRecyclerView.setNestedScrollingEnabled(false);

        mAdapter = new JadwalAdapter(JadwalPoliHariIni.this, mItems);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(final MenuItem item) {
                ...
                if (id == R.id.nav_history) {
                    Intent intent = new Intent(JadwalPoliHariIni.this, HistoryListActivity.class);
                    startActivity(intent);

                }else if (id == R.id.nav_pendaftaran){
                    Intent intent = new Intent(JadwalPoliHariIni.this, JadwalListActivity.class);
                    startActivity(intent);


                } else if (id == R.id.nav_all_jadwal_poli){
                    Intent intent = new Intent(JadwalPoliHariIni.this, AllJadwalActivity.class);
                    startActivity(intent);
    ...
    private void logoutConfirmDialog() {
        ...
        ((Button) dialog.findViewById(R.id.bt_accept)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JadwalPoliHariIni.this, LoginActivity.class);
