...
public class JadwalPoliRegulerBesok extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poli_reguler_besok);
        ...
        mManager = new LinearLayoutManager(JadwalPoliRegulerBesok.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mManager);
        mRecyclerView.setNestedScrollingEnabled(false);

        mAdapter = new JadwalAdapter(JadwalPoliRegulerBesok.this, mItems);
    ...
    protected void onResume(){
        ...
        if(action == null || !action.equals("Already created")) {
            ...
            Intent intent = new Intent(this, JadwalPoliRegulerBesok.class);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(final MenuItem item) {
                ...
                if (id == R.id.nav_history) {
                    Intent intent = new Intent(JadwalPoliRegulerBesok.this, HistoryListActivity.class);
                    startActivity(intent);

                }else if (id == R.id.menu_hari_ini){
                    Intent intent = new Intent(JadwalPoliRegulerBesok.this, PilihHariPoliReguler.class);
                    startActivity(intent);

                } else if(id == R.id.nav_exec) {

                    Intent intent = new Intent(JadwalPoliRegulerBesok.this, PilihHariPoliEksekutif.class);
                    startActivity(intent);



                } else if (id == R.id.nav_all_jadwal_poli) {
                    Intent intent = new Intent(JadwalPoliRegulerBesok.this, AllJadwalActivity.class);
                    startActivity(intent);
...
//                    finish();
    ...
    private void logoutConfirmDialog() {
        ...
        ((Button) dialog.findViewById(R.id.bt_accept)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JadwalPoliRegulerBesok.this, LoginActivity.class);
    ...
    public void initJadwal() {
        ...
        if (Harihariini == "Sabtu") {
            ...
            headerJadwal.setText("Jadwal Poli Reguler Lusa");
            ...
            headerJadwal.setText("Jadwal Poli Reguler Besok");
    ...
    public void showDialogJadwalWeekend(){
        ...
        if (Harihariini == "Sabtu") {
            ...
            title.setText("Jadwal Untuk Hari " + hariBesok + " Tidak tersedia");
            content.setText("Mohon untuk mendaftar besok pada hari " + hariLusa + ", " + tanggalLusa);
