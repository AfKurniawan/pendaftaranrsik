...
public class JadwalListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mManager = new LinearLayoutManager(JadwalListActivity.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mManager);
        mRecyclerView.setNestedScrollingEnabled(false);

        mAdapter = new JadwalAdapter(JadwalListActivity.this, mItems);
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle("Jadwal Poli Besok");
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(final MenuItem item) {
                ...
                if (id == R.id.nav_history) {
                    Intent intent = new Intent(JadwalListActivity.this, HistoryListActivity.class);
                    startActivity(intent);

                }else if (id == R.id.menu_hari_ini){
                    Intent intent = new Intent(JadwalListActivity.this, JadwalPoliHariIni.class);
                    startActivity(intent);
    ...
    private void logoutConfirmDialog() {
        ...
        ((Button) dialog.findViewById(R.id.bt_accept)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JadwalListActivity.this, LoginActivity.class);
