...
public class JadwalPoliRegulerHariIni extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poli_reguler_hari_ini);
        ...
        mManager = new LinearLayoutManager(JadwalPoliRegulerHariIni.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerView.setLayoutManager(mManager);
        mRecyclerView.setNestedScrollingEnabled(false);

        mAdapter = new JadwalAdapter(JadwalPoliRegulerHariIni.this, mItems);
    ...
    protected void onResume(){
        ...
        if(action == null || !action.equals("Already created")) {
            ...
            Intent intent = new Intent(this, JadwalPoliRegulerHariIni.class);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(final MenuItem item) {
                ...
                if (id == R.id.nav_history) {
                    Intent intent = new Intent(JadwalPoliRegulerHariIni.this, HistoryListActivity.class);
                    startActivity(intent);

                }else if (id == R.id.menu_hari_ini){
                    Intent intent = new Intent(JadwalPoliRegulerHariIni.this, PilihHariPoliReguler.class);
                    startActivity(intent);

                } else if(id == R.id.nav_exec) {

                    Intent intent = new Intent(JadwalPoliRegulerHariIni.this, PilihHariPoliEksekutif.class);
                    startActivity(intent);


                } else if (id == R.id.nav_all_jadwal_poli) {
                    Intent intent = new Intent(JadwalPoliRegulerHariIni.this, AllJadwalActivity.class);
                    startActivity(intent);
    ...
    private void logoutConfirmDialog() {
        ...
        ((Button) dialog.findViewById(R.id.bt_accept)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(JadwalPoliRegulerHariIni.this, LoginActivity.class);
    ...
    public void initJadwalBesok() {
        ...
        if(Harihariini == "Minggu"){
            ...
            headerJadwal.setText("Jadwal Poli Reguler Hari Ini");
        }
